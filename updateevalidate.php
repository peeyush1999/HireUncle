...
$updatequery="UPDATE employeedata SET email='$email', mobileno='$mobile', aadharno='$aadhar',address='$address',city='$city',state='$state',exp='$exp' WHERE username='$username'";
...
<div class="container">
	<br><br><br>
	<p style="font-size:1.5em;color:white" align="center">Employee  !!  You have successfully updated your Profile<br>
	<br><br><br>
