...
<div class="container-fluid">
	<div class="grp" style="background-color: #3c3d3f ;width: 60% ;margin:auto;padding:20px 5px 20px 5px; border-radius:20px;min-width:275px">
		...
		<div class="dashboard">
		<a href="home.php">	<button type="button" class="btn" style="width:50%;min-width:175px;padding:2px 2px 2px 2px;"><span class="dashboard1" >Search</span></button></a>
		</div>
		<div class="dashboard">
		...
		<div class="dashboard">
			<a href='submitfeedback.php'><button type="button" class="btn" style="width:50%;min-width:175px;padding:2px 2px 2px 2px;"><span class="dashboard1">Submit Feedback</span></button></a>
		</div>
		<div class="dashboard">
		<a href="uprofileupdate.php">	<button type="button" class="btn" style="width:50%;min-width:175px;padding:2px 2px 2px 2px;"><span class="dashboard1">Update Profile</span></button></a>
		</div>
		<div class="dashboard">
