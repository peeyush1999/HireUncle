...
$query="SELECT username,name,mobileno,aadharno,email,address,city,state,exp,skill FROM employeedata where username='$username'";
$stmt=$conn->prepare($query);
$stmt->execute();

$stmt->bind_result($uname,$name,$mobile,$aadhar,$email,$address,$city,$state,$exp,$skill);
$stmt->fetch();
?>
...
<div class='container'>
	<div class='row' style="min-width:600px;">
		<form class='update-profile' id='update-profile' action='updateevalidate.php' onsubmit='return employee_update_validate();' method='post'>
			<div class='form-group' >
				<label style='font-size:1.5em'><b>Update Employee Profile</b></label>				
			</div>
			...
			<div class='form-group1' >
				 ...
				 <input type='text' placeholder='Update Your Experience' name='exp' class='exp form-control' required <?php echo 'value='.$exp ?>> 
			</div>
			<div class='form-group1' >
			...
			<div class='form-group1'>
				 <label><b>State</b></label> 
						...
						<select name='state' id='state' class='form-first-name form-control' style='color:gray;'>
			...
			<div class='form-group' align='center' style='margin:20px 0px 20px 0px;' >
			 <button type='submit' name='submit'  class='btn' style='width:30%;min-width:120px !important'>Update</button>  <button type='reset' name='reset'  class='btn' style='width:30%;min-width:120px;' >Reset </button>
			</div>
